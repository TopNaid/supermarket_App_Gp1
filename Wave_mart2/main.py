...
class Main(Login, Admin, User):
    ...
    def __init__(self):
        ...
        self.main_window.title("Wave Mart")
    ...
    def buildmain(self):
        ...
        title = Label(canvas_top, text="Wave Mart", bg=TOP_NAV_COLOR,fg="steelblue" , font=('Century', 30, 'normal'))
    ...
    def change_user(self):
        if messagebox.askyesno("Alert!", "Do  you want to sign out?"):
            self.base.commit()
